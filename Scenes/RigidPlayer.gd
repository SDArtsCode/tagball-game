...
const MAX_SPEED = 200.0*1.25 # walking
const ACCEL = 7.0*1.25 # walking accel
const SLIDE_RESET_TIME : float = 2.0/1.25 # how much time until can slide again
const SLIDE_SPEED_MULT : float = 3.7*1.125 # when pressing slide, how much is the current vel multipled by
